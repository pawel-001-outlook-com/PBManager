            ...
            Selectpicker.prototype = {
                ...
                createView: function(isSearching, scrollTop) {
                    ...
                    function scroll(scrollTop, init) {
                        ...
                        var chunks = [];
                        var chunkSize =
                            Math.ceil(that.sizeInfo.menuInnerHeight /
                        ...
                        if (that.activeIndex !== undefined) {
                            prevActive =
                                that.selectpicker.current.elements[that.selectpicker.current.map.newIndex[that
                                    .prevActiveIndex]];
                            active =
                                that.selectpicker.current.elements[that.selectpicker.current.map.newIndex[that
                                    .activeIndex]];
                        ...
                        if (init ||
                            ...
                            that.selectpicker.view.visibleElements =
                                that.selectpicker.current.elements.slice(that.selectpicker.view.position0,
                            ...
                            for (var i = 0, visibleElementsLen = that.selectpicker.view.visibleElements.length;
                ...
                createLi: function() {
                    ...
                    $selectOptions.each(function(index) {
                        ...
                        if (thisData.hidden === true ||
                            that.options.hideDisabled && (isDisabled && !isOptgroup || isOptgroupDisabled)) {
                        ...
                        if (isOptgroup && thisData.divider !== true) {
                            ...
                            if (!this.previousElementSibling) { // Is it the first option of the optgroup?
                                ...
                                mainElements.push(generateLI(labelElement,
                                    null,
                            ...
                            mainElements.push(generateLI(
                                generateA(textElement, "opt " + optionClass + optGroupClass, inline),
                                index,
                                "",
                                optID));
                            mainData.push({
                            ...
                            if (selectedItemsInTitle.length < 100 && that.options.selectedTextFormat !== "count") {
                                ...
                                var $this = $(this),
                                    ...
                                    icon = thisData.icon && that.options.showIcon
                                        ? '<i class="' + that.options.iconBase + " " + thisData.icon + '"></i> '
                                        : "",
                                    subtext,
                                    titleItem;
                ...
                setMenuSize: function(isAuto) {
                    ...
                    if (this.options.dropdownAlignRight === "auto") {
                        this.$menu.toggleClass("dropdown-menu-right",
                ...
                setSize: function(refresh) {
                    ...
                    if (this.options.size === "auto") {
                        this.$searchbox.off("input.setMenuSize propertychange.setMenuSize").on(
                            "input.setMenuSize propertychange.setMenuSize",
                            function() {
                                return that.setMenuSize();
                            });
                        $window.off("resize.setMenuSize scroll.setMenuSize").on("resize.setMenuSize scroll.setMenuSize",
                            function() {
                                return that.setMenuSize();
                            });
                    } else if (this.options.size &&
                ...
                setOptionStatus: function() {
                    ...
                    if (that.selectpicker.view.visibleElements && that.selectpicker.view.visibleElements.length) {
                        for (var i = 0; i < that.selectpicker.view.visibleElements.length; i++) {
                            var index =
                                    that.selectpicker.current.map.originalIndex[i + that.selectpicker.view.position0
                            ...
                            if (option) {
                                ...
                                that.setDisabled(
                                    index,
                                    option.disabled ||
                                    option.parentNode.tagName === "OPTGROUP" && option.parentNode.disabled,
                                    liIndex,
                                    li
                                );
                ...
                clickListener: function() {
                    ...
                    this.$menuInner.on("click",
                        "li a",
                        function(e, retainActive) {
                            var $this = $(this),
                                clickedIndex =
                                    that.selectpicker.current.map.originalIndex[$this.parent().index() +
                            ...
                            if (searchValue) {
                                ...
                                for (var i = 0, cacheLen = cacheArr.length; i < cacheLen; i++) {
                                    ...
                                    (li.type === "divider" &&
                                        ...
                                        that.selectpicker.search.map.originalIndex[searchMatch.length - 1] =
                                            li.originalIndex;
                                    }
                                }
                ...
                changeAll: function(status) {
                    ...
                    for (var i = 0; i < this.selectpicker.current.elements.length; i++) {
                        var index =
                                this.selectpicker.current.map.originalIndex[i
                                ], // faster than $(li).data('originalIndex')
                            option = $selectOptions[index];
                    ...
                    if (isArrowKey) { // if up or down
                        ...
                        if (e.which === keyCodes.ARROW_UP) { // up
                            ...
                            if (!that.selectpicker.view.canHighlight[index + that.selectpicker.view.position0]) {
                                index = that.selectpicker.view.canHighlight
                                    .slice(0, index + that.selectpicker.view.position0).lastIndexOf(true) -
                                    that.selectpicker.view.position0;
                                if (index === -1) index = $items.length - 1;
                            }
                        } else if (e.which === keyCodes.ARROW_DOWN || downOnTab) { // down
                            index++;
                            if (index + that.selectpicker.view.position0 >= that.selectpicker.view.canHighlight.length)
                                index = 0;
                            ...
                            if (!that.selectpicker.view.canHighlight[index + that.selectpicker.view.position0]) {
                                index = index +
                                    ...
                                    .slice(index + that.selectpicker.view.position0 + 1).indexOf(true);
                            }
                        }
