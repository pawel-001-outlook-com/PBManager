            ...
            var dragListener = new DragListener(view.coordMap,
                {
                    ...
                    cellOver: function(cell, isOrig) {
                        var origCell =
                            seg.cell || dragListener.origCell; // starting cell could be forced (DayGrid.limit)
    ...
    function Calendar(element, instanceOptions) {
        ...
        function zoomTo(newDate, viewType) {
            ...
            if (!viewType || !isValidViewType(viewType)) { // a general view name, or "auto"
                ...
                viewStr =
                    header.getViewsWithButtons().join(" "); // space-separated string of all the views in the header
                            ...
                            function(j, buttonName) {
                                ...
                                if (buttonName == "title") {
                                    ...
                                    if (buttonClick) {
                                        ...
                                        defaultText =
                                            smartProperty(options.defaultButtonText, buttonName); // from languages
