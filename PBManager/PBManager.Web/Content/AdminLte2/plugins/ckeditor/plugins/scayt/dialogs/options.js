...
CKEDITOR.dialog.add("scaytcheck",
    function(j) {
            ...
            B = {
                ...
                onShow: function() {
                    ...
                    if (!a.data || !a.data.scayt || !a.data.scayt_control)
                        ...
                        var b = 0;
                        s
                            ? a.data.scayt.getCaption(j.langCode || "en",
                                function(e) {
                                    0 < b++ ||
                ...
                onCancel: function() {
                    ...
                    a = "undefined" != typeof document.forms["languagesbar_" + b]
        ...
        var A = function() {
                ...
                if (1 == l[0])
                    for (c in v)
                        d = "label_" + v[c], g = f.getById(d + "_" + b), "undefined" != typeof g &&
                ...
                if (1 == l[0])
                    for (var g = w(), e = 0, d = g.length; e < d; e++) {
                        ...
                        if (i && (g[e].checked = !1, 1 == a.options[h.split("_")[0]] && (g[e].checked = !0), s))
                            i.on("click", function() { a.options[this.getId().split("_")[0]] = this.$.checked ? 1 : 0 })
                    }
                1 ==
                    l[1] &&
                    (g = f.getById("cke_option" + a.sLang), x(g.$, a.sLang));
                u &&
                (window.scayt.getNameUserDictionary(function(a) {
                        a = a.dname;
                        q(m[0] + "," + m[1]);
                        if (a) {
