...
(function() {
                    ...
                    return function(d) {
                        ...
                        if (1 == a.length)
                            if (document.addEventListener)
                                document.addEventListener("DOMContentLoaded", b, !1), window.addEventListener("load",
                                    b,
                                    !1);
    ...
    CKEDITOR.event ||
    (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
    ...
    (CKEDITOR.env = function() {
        ...
        b.cssClass =
            "cke_browser_" + (b.ie ? "ie" : b.gecko ? "gecko" : b.opera ? "opera" : b.webkit ? "webkit" : "unknown");
            ...
            (function() {
                CKEDITOR.domReady(function() {
                    ...
                    if (a) {
                        ...
                        a && a._load
                            ? a()
                            : e && setTimeout(function() { CKEDITOR.loadFullCore && CKEDITOR.loadFullCore() }, e * 1E3)
                    }
                })
            })();
        ...
        CKEDITOR.tools = {
            ...
            extend: function(b) {
                ...
                for (var e = 1; e < a; e++) {
                    ...
                    for (i in n)
                        if (d ===
                            true ||
                            b[i] == void 0) if (!h || i in h) b[i] = n[i]
                }
                return b
            },
            ...
            cssStyleToDomStyle: function() {
                var b = document.createElement("div").style,
                    a = typeof b.cssFloat != "undefined"
                        ? "cssFloat"
                        : typeof b.styleFloat != "undefined"
                        ? "styleFloat"
                        : "float";
                return function(d) {
                    return d == "float" ? a : d.replace(/-./g, function(d) { return d.substr(1).toUpperCase() })
                }
            }(),
            ...
            htmlEncodeAttr:
                function(b) { return b.replace(/"/g, "&quot;").replace(/</g, "&lt;").replace(/>/g, "&gt;") },
            ...
            setTimeout: function(b, a, d, h, e) {
                e || (e = window);
                d || (d = e);
                return e.setTimeout(function() { h ? b.apply(d, [].concat(h)) : b.apply(d) }, a || 0)
            },
            trim: function() {
                var b = /(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g;
    ...
    CKEDITOR.dom.node = function(a) {
        return a
            ? new CKEDITOR.dom[a.nodeType == CKEDITOR.NODE_DOCUMENT
                ? "document"
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype,
        {
            ...
            getPosition: function(a) {
                ...
                for (var e = this.getAddress(), a = a.getAddress(), b = Math.min(e.length, a.length), c = 0;
                    c <= b - 1;
                    c++)
                    if (e[c] != a[c]) {
    ...
    CKEDITOR.dom.element.get = function(a) {
        return(a = typeof a == "string" ? document.getElementById(a) || document.getElementsByName(a)[0] : a) &&
    ...
    CKEDITOR.dom.element.setMarker = function(a, e, b, c) {
        var d = e.getCustomData("list_marker_id") ||
                e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            h = e.getCustomData("list_marker_names") ||
                ...
                isEmptyInlineRemoveable: function() {
                    ...
                    for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
                        ...
                        (e.type == CKEDITOR.NODE_ELEMENT && !e.isEmptyInlineRemoveable() ||
                            e.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(e.getText()))) return false
                    }
                    return true
                },
                hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat)
                    ? function() {
                        for (var a = this.$.attributes, b = 0;
                            b <
                                a.length;
                            b++) {
                            var c = a[b];
    ...
    (function() {
        ...
        CKEDITOR.dom.element.prototype.getBogus = function() {
            ...
            while (n(a) ||
                g(a) ||
                a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty));
        ...
        CKEDITOR.dom.range.prototype =
        {
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    f = c;
                    var e = d;
                    f = f.type != CKEDITOR.NODE_ELEMENT || e === 0 || e == f.getChildCount()
                        ? 0
                        : f.getChild(e - 1).type == CKEDITOR.NODE_TEXT && f.getChild(e).type == CKEDITOR.NODE_TEXT;
                    if (f) {
                        c = c.getChild(d - 1);
                        d = c.getLength()
                    }
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var z,
                        M,
                        Q = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS
                            ? { br: 1 }
                            : null),
                        v = null,
                        w = function(a) {
                    ...
                    z = z || e;
                    this.setStartAt(z,
                        !z.is("br") && (!k && this.checkStartOfBlock() || k && z.contains(k))
                ...
                if (!this.collapsed) {
                    ...
                    if (k)
                        (f = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
                            this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                    if (l) {
                        d.reset();
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var c =
                    ...
                    if (a.type == CKEDITOR.NODE_TEXT) {
                        b && this.endContainer && this.checkEndOfBlock() && n.test(a.getText())
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (!this._.started) {
                    ...
                    f.enlarge(this.forceBrBreak && !g || !this.enlargeBr
                ...
                if (s)
                    (s = b.getPrevious()) &&
                        ...
                        (s.getName() == "br"
                            ? s.remove()
                            : s.getLast() && s.getLast().$.nodeName.toLowerCase() == "br" && s.getLast().remove());
                if (u)
                    (s = b.getLast()) &&
                        s.type == CKEDITOR.NODE_ELEMENT &&
                        s.getName() == "br" &&
            ...
            if (t.$empty[d] || !a.children.length)
                ...
                if (b == "br") {
                    ...
                    if (f) {
                        ...
                        f = a.parent;
                        for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", l, k = d.length;
                            k > 0;
                        ) {
                            m = d[--k];
                            if (e &&
        ...
        CKEDITOR.focusManager.prototype = {
            ...
            add: function(a, e) {
                ...
                if (!b ||
                    ...
                    var d = {
                        blur: function() { a.equals(this.currentActive) && this.blur() },
    ...
    (function() {
        CKEDITOR.lang = {
            ...
            load: function(a, e, b) {
                ...
                this[a]
                    ? b(a, this[a])
                    : CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("lang/" + a + ".js"),
                        function() {
    ...
    (function() {
        function a(a, c, h) {
            ...
            if (c !== void 0) {
                ...
                if (!(h == CKEDITOR.ELEMENT_MODE_INLINE
                ...
                _attachToForm: function() {
                    ...
                    if (b.is("textarea") && c) {
                        ...
                        if (c.$.submit && c.$.submit.call && c.$.submit.apply)
                            c.$.submit = CKEDITOR.tools.override(c.$.submit,
                                function(a) {
                                    return function() {
                                        d();
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.cdata.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node,
            { type: CKEDITOR.NODE_TEXT, filter: function() {}, writeHtml: function(a) { a.write(this.value) } })
    })();
    "use strict";
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(d, h, g) {
            ...
            var u = new CKEDITOR.htmlParser,
                f = h instanceof CKEDITOR.htmlParser.element
                    ? h
                    : typeof h == "string"
            ...
            u.onTagOpen = function(d, f, h, g) {
                ...
                if (a(f)) p.push(f);
                    ...
                    if (d == "br") y.push(f);
                        ...
                        for (;;) {
                            g = (h = m.name)
                                ? CKEDITOR.dtd[h] || (m._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                                : c;
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onElement: function(a, c) {
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, g = 0;
                        g < 3;
                        g++)
                        if (e = d[g]) {
                            e = e.exec(a, c, this);
    ...
    (function() {
                        ...
                        (typeof d == "function"
                            ...
                            if (!v && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                ...
                                (document.documentMode > 7 ||
                                    ...
                                    e.name in CKEDITOR.dtd.$listItem)) k = false;
                            else {
                                k = b(e);
        ...
        function s(a) {
            return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g,
                function(a) { return"<\!--" + m + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\>" })
        }
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml",
                function(a) {
                    ...
                    c = q(c);
                    c = u(c);
                    a.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(c,
                        a.context,
                        a.fixForBody === false ? false : e(a.enterMode, b.config.autoParagraph))
                },
                null,
                null,
                5);
    ...
    CKEDITOR.htmlParser.element = function(a, e) {
        ...
        c && (b = c[1]);
        b = !(!CKEDITOR.dtd.$nonBodyContent[b] &&
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node,
            {
                ...
                split: function(a) {
                    for (var b = this.children.splice(a, this.children.length - a), e = this.clone(), g = 0;
                        g < b.length;
                        ++g) b[g].parent = e;
                    e.children = b;
                ...
                removeClass: function(a) {
                    ...
                    if (b)
                        (b = CKEDITOR.tools.trim(b.replace(RegExp("(?:\\s+|^)" +
                                    a +
                                    "(?:\\s+|$)"),
                                " ")))
    ...
    (function() {
        ...
        function b(a) {
            ...
            c ||
            (c = CKEDITOR.addTemplate("maincontainer",
    ...
    (function() {
        function a(a) {
            ...
            if (b.config.autoParagraph !== false &&
            ...
            proto: {
                ...
                insertText: function(a) {
                    ...
                    if (!b) {
                        ...
                        if (d.test(a))
                            var l = "<" + c + ">",
                                h = "</" + c + ">",
                                a = l + a.replace(d, function() { return h + l }) + h
                    }
                    a = a.replace(/\n/g, "<br>");
                ...
                insertElementIntoSelection: function(a) {
                    ...
                    if (this.insertElementIntoRange(a, d)) {
                        ...
                        if (k)
                            if ((k = a.getNext(function(a) { return c(a) && !i(a) })) &&
                    ...
                    this.attachListener(a,
                        ...
                        function() {
                            ...
                            this.is("textarea") ||
                                ...
                                (b = b.replace(j, function(a, b) { return b }));
                            a.setData(b, null, 1)
                        },
                        this);
                            ...
                            function(b) {
                                ...
                                if (c in k) {
                                    var b = a.getSelection(),
                                        ...
                                        n,
                                        c = c == 8;
                                    if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) ||
                                        (d = h(b))) {
                                        a.fire("saveSnapshot");
                                        ...
                                        if ((i = g.block) &&
                                            ...
                                            m.checkBoundaryOfElement(j, c ? CKEDITOR.START : CKEDITOR.END) &&
                                            ...
                                            a.fire("saveSnapshot");
                                            e = 1
                                        } else if ((j = g.contains(["td", "th", "caption"])) &&
                                            m.checkBoundaryOfElement(j, c ? CKEDITOR.START : CKEDITOR.END)) e = 1
                                }
                                return!e
                            });
                        a.blockless &&
        ...
        var s = function() {
                ...
                function k(b, c, e, d) {
                    ...
                    if ((m = (new CKEDITOR.dom.walker(l)).next()) &&
                        a(m) &&
                        h[m.getName()] &&
                        (g = m.getPrevious()) &&
                        a(g) &&
                ...
                return function(h,
                    ...
                    if (!x.checkReadOnly()) {
                        ...
                        for (;
                            (D = a(q.startContainer) && q.startContainer.getChild(q.startOffset - 1)) &&
                                a(D) &&
                                D.isBlockBoundary() &&
                                H.contains(D);
                        ...
                        if (w) {
                            ...
                            C = v.getPosition(H);
                            X = !!v.getCommonAncestor(H) &&
                                C != CKEDITOR.POSITION_IDENTICAL &&
                                !(C & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                            H = b(j.dataWrapper, j);
                                ...
                                if (B) s = w > 0;
                                    ...
                                    if (!C.isBlock &&
                                        ...
                                        (j.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                                            ...
                                            !B.block) &&
                                        (O = j.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                                            j.editor.config.autoParagraph !== false
                                    ...
                                    if (q && C.isElement) {
                                        ...
                                        if (B) {
                                            ...
                                            B = w == H.length - 1;
                                            K = e(C.node, K);
                                            for (var N = [], U = K.length, Y = 0, $ = void 0, aa = 0, ba = -1;
                                                Y < U;
                                                Y++) {
                                                $ = K[Y];
                                                if ($ == " ") {
                        ...
                        J.moveToBookmark(S);
                        if (!j.dontMoveCaret) {
                            for (G = a(J.startContainer) && J.startContainer.getChild(J.startOffset - 1);
                                G && a(G) && !G.is(g.$empty);
                            ) {
    ...
    (function() {
        ...
        function c(a) {
            ...
            return b(e) ||
                b(d, 1) ||
                !e && !d && !(c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() && c.getBogus())
                ? true
                : false
        }
        ...
        function n(a, b, c) {
            ...
            if (CKEDITOR.env.ie)
                var d = a.getDocument().on("selectionchange", function(a) { a.cancel() }, null, null, -100);
            else {
            ...
            return function(c) {
                ...
                if (b[e]) {
                    ...
                    if (d.length == 1 && f.collapsed)
                        if ((e = f[e < 38 ? "getPreviousEditableNode" : "getNextEditableNode"]()) &&
            ...
            function(b) {
                    ...
                    function() {
                        ...
                        k.attachListener(k,
                            ...
                            function() {
                                o &&
                                    CKEDITOR.env.webkit &&
                                    (o = d._.previousActive && d._.previousActive.equals(b.getActive()));
                                d.unlockSelection(o);
                                o = 0
                            },
                            null,
                                        ...
                                        function(a) {
                                            function b(a) {
                                                ...
                                                if (e) {
                                                    ...
                                                    e.setEndPoint(f.compareEndPoints("StartToStart", c) < 0
                                                        ? "EndToEnd"
                                                        : "StartToStart",
                                                        c);
                                                    e.select()
                        ...
                        if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                            ...
                            k.attachListener(b.getDocumentElement(),
                                "mouseup",
                                function() {
                                    w && e.call(d);
                                    w = 0
                ...
                d.on("loadSnapshot",
                    function() {
                        ...
                        a &&
                            a.hasAttribute("data-cke-hidden-sel") &&
                            a.remove()
                    },
                    null,
                    null,
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (CKEDITOR.env.webkit)
                ...
                if (f) b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && n(a, null, true);
                    ...
                    d &&
                        (d.equals(this.document.getDocumentElement()) && b && (a.equals(b) || a.contains(b))) &&
                        n(a, null, true)
                }
            }
            d = this.getNative();
            ...
            if (d)
                if (d.getRangeAt)
                    ...
                    g = h &&
                        CKEDITOR.dom.element.get(h.item && h.item(0) ||
                            h.parentElement())
                }
            if (!g ||
                ...
                : function() {
                    ...
                    if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                        ...
                        if (d == c.endContainer &&
                            ...
                            y[d.childNodes[c.startOffset].nodeName.toLowerCase()]) b = CKEDITOR.SELECTION_ELEMENT
                    }
                    return a.type = b
                },
            getRanges: function() {
                var a = f
                    ? function() {
                        ...
                        var b = function(b, c) {
                            ...
                            for (var e = d.children, f, g, h = b.duplicate(), l = 0, m = e.length - 1, j = -1, i, o;
                                l <= m;
                            ) {
                                j = Math.floor((l + m) / 2);
                                f = e[j];
                    ...
                    if (b)
                        for (var d = c.ranges, e = 0; e < d.length; e++) {
                            ...
                            if (!f.collapsed) {
                                ...
                                b &&
                                    b.type == CKEDITOR.NODE_TEXT &&
                                    (h >= b.getLength() ? i.setStartAfter(b) : i.setStartBefore(b));
                    ...
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) },
                        function() {
                            for (var a = b.getRanges()[0].clone(), c, d, e = 2;
                                e &&
                                (!(c = a.getEnclosedNode()) ||
                                    !(c.type == CKEDITOR.NODE_ELEMENT && y[c.getName()] && (d = c)));
                    ...
                    if (this.isLocked) {
                        ...
                        if (b) this.fake(b);
                            ...
                            if (f) {
                                ...
                                (b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in g ||
                                ...
                                if (p) {
                                    ...
                                    j = !(j && j.getText && j.getText().match(d)) &&
                                        (i || !g.hasPrevious() || g.getPrevious().is && g.getPrevious().is("br"));
                                ...
                                for (o = 0; o < a.length; o++) {
                                    ...
                                    if (CKEDITOR.env.opera && b.collapsed && j.type == CKEDITOR.NODE_ELEMENT) {
                                        ...
                                        if (!d && !e && j.is(CKEDITOR.dtd.$removeEmpty) ||
    ...
    (function() {
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        x = s
                            ...
                            : p && !i
                            ? 0
                            : (n.getPosition(o) | M) == M && (!g.childRule || g.childRule(n))
                            : 1;
                        if (x)
                            if ((x = n.getParent()) &&
        ...
        function b(a) {
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, j = 0, h;
        ...
        function q(a, b) {
            ...
            for (var d = 0; d < a.length; d++) {
                var e = a[d],
                    ...
                    e = e.replace(/\n/g, "<br>"),
                    e = e.replace(/[ \t]{2,}/g,
                        function(a) { return CKEDITOR.tools.repeat("&nbsp;", a.length - 1) + " " });
                if (c) {
                    var f = b.clone();
                    f.setHtml(e);
                    c.append(f)
        ...
        function s(a, b) {
            var c = this._.definition,
                ...
                h;
            for (h in d)
                if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != t(h, d[h])) &&
                    !(b && h.slice(0, 5) == "data-")) {
                    g = a.hasAttribute(h);
                    a.removeAttribute(h)
                }
        ...
        var e = {
            ...
            createBookmarks2: function(a) {
                for (var c =
                    ...
                    d = 0;
                    d < this.length;
                    d++) c.push(this[d].createBookmark2(a));
                return c
            },
...
*/
    ...
    (function() {
        ...
        function U(a) {
            function b(b) {
                ...
                a.move(d.x + i[3] < f
                    ...
                    : d.x,
                    d.y + i[0] < f ? -i[0] : d.y - i[2] > h.height - c.height - f ? h.height - c.height + i[2] : d.y,
                    1);
        ...
        function J(a) {
            ...
            f
                ...
                : (g =
                    ...
                    g.push("</div>"), f =
                        CKEDITOR.dom.element.createFromHtml(g.join("")), f.setOpacity(void 0 != d ? d : 0.5),
        ...
        function K(a) {
            q &&
            (a.focusManager.remove(q), a =
                CKEDITOR.document.getWindow(), q.hide(), a.removeListener("resize", F), CKEDITOR.env.ie6Compat &&
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function d(b) {
                if (m ==
                    ...
                    if (9 == c || c == CKEDITOR.SHIFT + 9)
                        c = c == CKEDITOR.SHIFT + 9, m._.tabBarMode
                        ...
                        (c = this.getButton("cancel"))
                            ...
                            : !1 !== this.fire("cancel", { hide: !0 }).hide && this.hide(), j = 1;
                    else return;
                    g(b)
                }
            }
            ...
            var f = CKEDITOR.dialog._.dialogDefinitions[b],
                ...
                o,
                j;
            ("OS" == l && CKEDITOR.env.mac || "rtl" == l && "ltr" == k || "ltr" == l && "rtl" == k) &&
                i.buttons.reverse();
            ...
            this.parts.tabs.on("click",
                function(a) {
                    ...
                    (b = b.$.id, this.selectPage(b.substring(4, b.lastIndexOf("_"))), this._.tabBarMode &&
                        (this._.tabBarMode = !1, this._.currentFocusIndex = -1, e(1)), a.data.preventDefault())
                },
                this);
            k = [];
        ...
        CKEDITOR.dialog.prototype = {
            ...
            resize: function() {
                return function(a, b) {
                    if (!this._.contentSize || !(this._.contentSize.width == a && this._.contentSize.height == b))
                        CKEDITOR.dialog.fire("resize", { dialog: this, width: a, height: b }, this._.editor), this.fire(
                                "resize",
                                { width: a, height: b },
                                this._.editor),
            ...
            move: function(a, b, c) {
                ...
                if (!g || !this._.position || !(this._.position.x == a && this._.position.y == b))
                    this._.position =
                            { x: a, y: b },
                        g || (g = CKEDITOR.document.getWindow().getScrollPosition(), a += g.x, b += g.y), d &&
                        (g = this.getSize(), a =
                            CKEDITOR.document.getWindow().getViewPaneSize().width - g.width - a),
                        b = { top: (0 < b ? b : 0) + "px" }, b[d ? "right" : "left"] =
                            (0 < a ? a : 0) + "px", e.setStyles(b), c && (this._.moved = 1)
            },
            ...
            show: function() {
                ...
                null === CKEDITOR.dialog._.currentTop
                    ...
                    : (this._.parentDialog =
                        ...
                        Math.floor(this._.editor.config.baseFloatZIndex /
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [],
                        ...
                        !e.notAllowed && ("hbox" != e.type && "vbox" != e.type) && f++, d[e.id] =
                            e, "function" == typeof e.getChild && g.push.apply(g, e.getChild());
                    f || (a.hidden = !0);
                    ...
                    a.accessKey &&
                    (O(this, this, "CTRL+" + a.accessKey, Y, Z), this._.accessKeyMap["CTRL+" +
                        a.accessKey] = a.id)
                }
            },
            ...
            hidePage: function(a) {
                ...
                b &&
                    ...
                    (a == this._.currentTabId && this.selectPage(t.call(this)), b.hide(), this._.pageCount--, this
                        .updateStyle())
            },
            showPage: function(a) {
        ...
        var F,
            ...
            M = function(a) {
                ...
                if ((b = s[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length)
                    b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data
                        .preventDefault()
            },
            N = function(a) {
                var b = a.data.$.ctrlKey || a.data.$.metaKey,
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        for (var m = h["class"] && h["class"].split ? h["class"].split(" ") : [], j = 0;
                            j < m.length;
                            j++) m[j] && (n[m[j]] = 1);
                        m = [];
                        for (j in n) m.push(j);
                        ...
                        n = (b.style || "").split(";");
                        b.align &&
                        (m = b.align, k["margin-left"] = "left" == m ? 0 : "auto", k["margin-right"] =
                            "right" == m ? 0 : "auto");
                        ...
                        (this.setValue = CKEDITOR.tools.override(this.setValue,
                            function(a) { return function(c) { a.call(this, b.setValue.call(this, c)) } }));
                        ...
                        (this.tabIndex = b.tabIndex ||
                            0, this.focusIndex = a._.focusList.push(this) - 1, this.on("focus",
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this,
                            ...
                            function() {
                                ...
                                b.push('"');
                                b.push('align="',
                                    CKEDITOR.tools.htmlEncode(d && d.align ||
        ...
        CKEDITOR.ui.dialog.uiElement.prototype = {
            ...
            registerEvents: function(a) {
                var b = /^on([A-Z]\w+)/,
                    c,
                    e = function(a, b, c, d) { b.on("load", function() { a.getInputElement().on(c, d, a) }) },
                    d;
                for (d in a)
                    if (c = d.match(b))
        ...
        (function() {
            ...
            CKEDITOR.dialog.validate = {
                ...
                inlineStyle: function(a) {
                    return this.functions(function(a) { return g.test(CKEDITOR.tools.trim(a)) }, a)
                },
                ...
                openDialog: function(a, b) {
                    ...
                    if ("function" == typeof e)
                        c = this._.storedDialogs || (this._.storedDialogs = {}), c =
                            c[a] || (c[a] = new CKEDITOR.dialog(this, a)), b &&
                            b.call(c,
                                c), c.show();
                    else {
                        if ("failed" == e)
                        ...
                        "string" == typeof e &&
                            CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(e),
                                function() {
    ...
    CKEDITOR.plugins.add("dialog",
        {
            requires: "dialogui",
            init: function(t) {
                t.on("doubleclick", function(u) { u.data.dialog && t.openDialog(u.data.dialog) }, null, null, 999)
            }
        });
    ...
    (function() {
        function w(b) {
            function a() {
                ...
                CKEDITOR.env.ie &&
                    e.on("paste",
                        function(e) { r || (f(), e.data.preventDefault(), u(e), l("paste") || b.openDialog("paste")) });
                CKEDITOR.env.ie &&
                (e.on("contextmenu", h, null, null, 0), e.on("beforepaste",
                    function(b) { b.data && !b.data.$.ctrlKey && h() },
                    null,
                    null,
                    0));
                e.on("beforecut", function() { !n && i(b) });
                var a;
                e.attachListener(CKEDITOR.env.ie ? e : b.document.getDocumentElement(),
                    "mouseup",
                    function() {
            ...
            function i() {
                if (CKEDITOR.env.ie &&
                    ...
                    if (e.getType() == CKEDITOR.SELECTION_ELEMENT && (a = e.getSelectedElement()))
                        d = e.getRanges()[0], c =
                                b.document.createText(""), c.insertBefore(a), d.setStartBefore(c), d.setEndAfter(a),
                            e.selectRanges([d]), setTimeout(
                                function() { a.getParent() && (c.remove(), e.selectElement(a)) },
                                0)
                }
            }
            ...
            function k(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    f
                        ...
                        : (CKEDITOR.env.webkit
                            ? (i.append(j), j.addClass("cke_editable"), i.is("body") ||
                            (f = "static" != i.getComputedStyle("position")
                                ? i
                                : CKEDITOR.dom.element.get(i.$.offsetParent), g = f.getDocumentPosition().y))
                            : i.getAscendant(CKEDITOR.env.ie ||
                                CKEDITOR.env.opera
                                ? "body"
                                : "html",
                    ...
                    setTimeout(function() {
                            ...
                            if (CKEDITOR.env.webkit &&
                                (a = j.getFirst()) &&
                                a.is &&
                                a.hasClass("Apple-style-span")) j = a;
            ...
            b.getClipboardData = function(a, d) {
                ...
                b.on("beforePaste",
                    ...
                    1E3);
                !1 === o() &&
                (b.removeListener("paste", c), k && b.fire("pasteDialog", f)
                    ? (b.on("pasteDialogCommit", i), b.on("dialogHide",
                        function(a) {
                            a.removeListener();
        ...
        function y(b, a) {
            ...
            CKEDITOR.env.webkit &&
                -1 < a.indexOf("<div>") &&
                (a = a.replace(/^(<div>(<br>|)<\/div>)(?!$|(<div>(<br>|)<\/div>))/g, "<br>")
                        .replace(/^(<div>(<br>|)<\/div>){2}(?!$)/g, "<div></div>"), a.match(/<div>(<br>|)<\/div>/) &&
                    (a = "<p>" +
                        a.replace(/(<div>(<br>|)<\/div>)+/g,
                            function(a) { return c(a.split("</div><div>").length + 1) }) +
                        "</p>"),
                    a = a.replace(/<\/div><div>/g, "<br>"), a = a.replace(/<\/?div>/g, ""));
            if ((CKEDITOR.env.gecko || CKEDITOR.env.opera) && b.enterMode != CKEDITOR.ENTER_BR)
                CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") &&
                    (a = "<p>" + a.replace(/(<br>){2,}/g, function(a) { return c(a.length / 4) }) + "</p>");
            return p(b, a)
        }
        ...
        function A(b, a, c) {
            ...
            a.writeHtml(d, c);
            var a = d.getHtml(),
                a = a.replace(/\s*(<\/?[a-z:]+ ?\/?>)\s*/g, "$1").replace(/(<cke:br \/>){2,}/g, "<cke:br />")
    ...
    (function() {
        function q(a, b, c, i, f) {
            var f = CKEDITOR.tools.genKey(b.getUniqueId(),
                    c.getUniqueId(),
                    a.lang.dir,
                    a.uiColor || "",
                    i.css || "",
                ...
                h = g[f];
            h ||
            (h = g[f] = new CKEDITOR.ui.panel(b, i), h.element =
                c.append(CKEDITOR.dom.element.createFromHtml(h.render(a), b)), h.element.setStyles({
                display: "none",
                position: "absolute"
            }));
            return h
            ...
            proto: {
                ...
                showBlock: function(a, b, c, i, f, h) {
                    ...
                    CKEDITOR.tools.setTimeout(function() {
                            var a = CKEDITOR.tools.bind(function() {
                                    ...
                                    m
                                        ? i < c &&
                                        (e = g > c ? e + c : b.width > c ? e - a.left : e - a.right + b.width)
                                        : i < c &&
                                        (e = g > c ? e - c : b.width > c ? e - a.right + b.width : e - a.left);
                                    c = a.top;
                                    b.height - a.top < f &&
                ...
                showAsChild: function(a, b, c, g, f, h) {
                    ...
                    (this.hideChild(), a.onHide = CKEDITOR.tools.bind(function() {
                        ...
                        !1, a.showBlock(b, c, g, f, h), this.blur(), (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat
                        ) &&
    ...
    CKEDITOR.plugins.add("menu",
        {
            ...
            beforeInit: function(g) {
                for (var h = g.config.menu_groups.split(","), m = g._.menuGroups = {}, l = g._.menuItems = {}, a = 0;
                    a < h.length;
                    a++) m[h[a]] = a + 1;
            ...
            proto: {
                ...
                show: function(a, b, c, k) {
                    ...
                    var b = b || ("rtl" == this.editor.lang.dir ? 2 : 1),
                        ...
                        f = this._.element;
                    if (!i) {
                        i = this._.panel = new CKEDITOR.ui.floatPanel(this.editor,
                        ...
                        i.onEscape = CKEDITOR.tools.bind(function(a) {
                            ...
                            this);
                        i.onShow =
                            function() { i._.panel.getHolderElement().getParent().addClass("cke cke_reset_all") };
            ...
            proto: {
                render: function(a, b, c) {
                    ...
                    a = {
                        ...
                        index: b,
                        iconStyle: CKEDITOR.skin.getIconStyle(g,
                    ...
                    proto: {
                        addTarget: function(a, c) {
                            a.on("contextmenu",
                                function(a) {
                                    ...
                                    if (!c || !b) {
                                        ...
                                        CKEDITOR.tools.setTimeout(function() { this.open(f, null, g, h) },
                            ...
                            if (CKEDITOR.env.webkit) {
                                ...
                                a.on("keydown",
                                    function(a) { d = CKEDITOR.env.mac ? a.data.$.metaKey : a.data.$.ctrlKey });
                                a.on("keyup", b);
                                a.on("contextmenu", b)
                            }
                        },
                        ...
                        g = function(c, h) {
                            ...
                            case 40:
                                return c.button && c.button.hasArrow
                                    ? (a.once("panelShow", function(b) { b.data._.panel._.currentBlock.onKeyDown(40) }),
                                        c.execute())
                                    : g(c, 40 == h ? o : e), !1;
                            case e:
                            case 38:
                        ...
                        function(c) {
                            if (c.data.space == a.config.toolbarLocation) {
                                ...
                                a.config.toolbarCanCollapse &&
                                    a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE &&
                                    b.push('<span class="cke_toolbox_main"' +
                                    ...
                                    a.addCommand("toolbarCollapse",
                                        {
                                            ...
                                            exec: function(b) {
                                                ...
                                                g
                                                    ? (c.show(), a.removeClass("cke_toolbox_collapser_min"),
    ...
    (function() {
        ...
        function n(a, c) {
            ...
            var t = CKEDITOR.tools.addFunction(j),
                u = CKEDITOR.tools.addFunction(function(d, e) {
                    ...
                    case b ? 37 : 39:
                    case CKEDITOR.SHIFT + 9:
                        return(b = CKEDITOR.document.getById(g + (d - 1))) ||
                        (b = CKEDITOR.document.getById(g +
        ...
        if (CKEDITOR.env.opera || CKEDITOR.env.gecko && CKEDITOR.env.mac) c += ' onkeypress="return false;"';
        CKEDITOR.env.gecko && (c += ' onblur="this.style.cssText = this.style.cssText;"');
        var v = CKEDITOR.addTemplate("pathItem",
    ...
    (function() {
        function l(e, c, b) {
            ...
            "wysiwyg" == e.mode &&
            (c || (c = e.activeEnterMode), e.elementPath().isContextFor("p") || (c = CKEDITOR.ENTER_BR, b = 1),
                e.fire("saveSnapshot"), c == CKEDITOR.ENTER_BR ? o(e, c, null, b) : p(e, c, null, b), e.fire(
                    "saveSnapshot"))
        }
                    ...
                    e.addCommand("shiftEnter",
                        {
                            modes: { wysiwyg: 1 },
                            editorFocus: !1,
                            exec: function(c) { l(c, c.activeShiftEnterMode, 1) }
                        });
            ...
            enterBlock: function(e, c, b, i) {
                if (b = b || q(e)) {
                    ...
                    if (j && h) {
                        if (a && (a.is("li") || a.getParent().is("li"))) {
                            ...
                            if (d.is("li"))
                                ...
                                if (e)
                                    if (d =
                                            f.createElement(c == CKEDITOR.ENTER_P ? "p" : "div"),
                                        l && d.setAttribute("dir", j), n && d.setAttribute("style", n),
                                        h && d.setAttribute("class", h), a.moveChildren(d), i || m)
                    ...
                    if (h = b.splitBlock(k)) {
                        ...
                        if (!e && !j)
                            a.is("li") &&
                            (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), d.evaluator =
                                function(a) {
                                    return!(u(a) ||
                                        t(a) ||
                                        a.type == CKEDITOR.NODE_ELEMENT &&
                                ...
                                (CKEDITOR.env.needsBrFiller ? f.createElement("br") : f.createText(" "))
                                .insertBefore(g)), a && b.moveToElementEditStart(a);
                        else {
                            if (c) {
            ...
            enterBr: function(e, c, b, i) {
                if (b = b || q(e)) {
                    ...
                    !i && "li" == h
                        ...
                        : (!i && j && r.test(h)
                            ? (j = a.getDirection())
                            ? (f = f.createElement("div"), f.setAttribute("dir", j), f.insertAfter(a), b.setStart(f, 0))
                            : (f.createElement("br").insertAfter(a), CKEDITOR.env.gecko &&
                                    f.createText("").insertAfter(a),
                                b.setStartAt(a.getNext(),
                                    CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START))
                            : (a = "pre" == h &&
                                CKEDITOR.env.ie &&
                                8 > CKEDITOR.env.version
                                ? f.createText("\r")
                                : f.createElement("br"), b.deleteContents(), b.insertNode(a), CKEDITOR.env.needsBrFiller
                                ? (f.createText("﻿").insertAfter(a), j && a.getParent().appendBogus(),
                                    a.getNext().$.nodeValue =
                                        "", b.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START))
                                : b.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), b.collapse(!0), b.select(), b
                            .scrollIntoView())
                }
            }
        };
    ...
    (function() {
        function q(a) {
            var i = a.config,
                ...
                o = function() {
                    ...
                    return function(d) {
                        if (r = a.editable())
                            if (d && "focus" == d.name && b.show(), b.removeStyle("left"), b.removeStyle("right"), k =
                                b.getClientRect(), c = r.getClientRect(), h = g.getViewPaneSize(), m = k.height, s =
                                "pageXOffset" in g.$
                                ? g.$.pageXOffset
                                : CKEDITOR.document.$.documentElement.scrollLeft, j) {
                                m + n <= c.top ? e("top") : m + n > h.height - c.bottom ? e("pin") : e("bottom");
                                var d = h.width / 2,
                                    d = 0 < c.left && c.right < h.width && c.width > k.width
        ...
        var u = CKEDITOR.addTemplate("floatcontainer",
        ...
        CKEDITOR.plugins.add("floatingspace",
            { init: function(a) { a.on("loaded", function() { q(this) }, null, null, 20) } })
    })();
    CKEDITOR.plugins.add("listblock",
        {
            requires: "panel",
            onLoad: function() {
                var f = CKEDITOR.addTemplate("panel-list",
    ...
    CKEDITOR.plugins.add("richcombo",
        {
            ...
            beforeInit: function(d) { d.ui.addHandler(CKEDITOR.UI_RICHCOMBO, CKEDITOR.ui.richCombo.handler) }
        });
    (function() {
        var d =
            ...
            proto: {
                ...
                render: function(a, b) {
                    ...
                    var k = CKEDITOR.tools.addFunction(function(b,
                            ...
                            if (40 == g)
                                a.once("panelShow", function(a) { a.data._.panel._.currentBlock.onKeyDown(40) });
                            switch (g) {
                            case 13:
                            case 32:
                            case 40:
                                        ...
                                        function(b) {
                                            ...
                                            for (var e in d)
                                                if (d[e].checkActive(b)) {
                                                    e !=
                                                        c &&
                                                        this.setValue(e, a.lang.format["tag_" + e]);
                                                    return
                                                }
                                            this.setValue("")
                                        },
    ...
    (function() {
        function k(a) {
            ...
            (b.getDocumentElement().addClass(b.$.compatMode), d.config.enterMode != CKEDITOR.ENTER_P &&
                this.attachListener(b,
                    ...
                    function() {
                        ...
                        e &&
                            (a.getHtml().match(/^<p>(?:&nbsp;|<br>)<\/p>$/i) && e.startContainer.equals(a)) &&
                            setTimeout(function() {
            ...
            if (CKEDITOR.env.webkit || CKEDITOR.env.ie && 10 < CKEDITOR.env.version)
                b.getDocumentElement().on("mousedown",
                    function(a) { a.data.getTarget().is("html") && setTimeout(function() { d.editable().focus() }) });
            try {
                    ...
                    if (d) this.setHtml(a), b.fire("dataReady");
                        ...
                        e
                            ? (/<body[\s|>]/.test(a) || (a = "<body>" + a),
                                ...
                                h && (a = a.replace(/<head>/, "$&" + h)), a = a.replace(/<\/head\s*>/, f + "$&"), a =
                                    g + a)
                            : a = c.docType +
                            '<html dir="' +
                    ...
                    if (!b.plugins.image2) {
                        ...
                        b.ui.addButton &&
                            b.ui.addButton("Image",
                                { label: b.lang.common.image, command: "image", toolbar: "insert,10" });
                        b.on("doubleclick",
                            function(b) {
                                var a =
                                    b.data.element;
                                a.is("img") &&
                                    (!a.data("cke-realelement") && !a.isReadOnly()) &&
                                    (b.data.dialog = "image")
                            });
                        b.addMenuItems &&
        ...
        CKEDITOR.plugins.add("indent",
            {
                init: function(a) {
                    ...
                    (a.ui.addButton("Indent",
                            { label: a.lang.indent.indent, command: "indent", directional: !0, toolbar: "indent,20" }),
                            ...
                            for (var l = new CKEDITOR.dom.walker(f), c; c = l.next();)
                                if (c.type == CKEDITOR.NODE_ELEMENT)
                                    if (!c.equals(j) &&
                                        ...
                                        if (d)
                                            for (var g = b.data.dir == "ltr" ? ["_rtl", ""] : ["", "_rtl"], h = 0;
                                                h < d.length;
                                                h++)
                            ...
                            (function(a, b) {
                                ...
                                for (c in b.jobs)
                                    e.on("exec",
                                        function(d) {
                                            d.data.done ||
                                            (a.fire("lockSnapshot"), b.execJob(a, c) &&
                                            (d.data.done =
                                                !0), a.fire("unlockSnapshot"), CKEDITOR.dom.element.clearAllMarkers(
                                                b.database))
                                        },
                                        this,
                                        null,
                ...
                if (m && m.length)
                    for (a = 0; a < m.length; a++) {
                        for (j = b = m[a]; (j = j.getNext()) && j.is && j.getName() in k;)
                            CKEDITOR.env.needsNbspFiller && !b.getFirst(t) && b.append(d.document.createText(" ")), b
                                .append(j);
                        b.insertAfter(i)
                    }
            ...
            for (var n = this,
                ...
                if (!b) {
                    ...
                    c &&
                        ...
                        (d.setStartAt(c, CKEDITOR.POSITION_AFTER_START), d.setEndAt(c, CKEDITOR.POSITION_BEFORE_END),
                            b = c)
                }
                b &&
                    (d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in k) &&
                    (c = new CKEDITOR.dom.walker(d), c.evaluator = i, d.startContainer = c.next());
                b &&
                    (d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName() in k) &&
        ...
        CKEDITOR.plugins.add("indentlist",
            {
                ...
                init: function(e) {
                    function g(e,
                        ...
                        this.jobs[this.isIndent ? 10 : 30] = {
                            refresh: this.isIndent
                                ...
                                : function(e, d) { return!this.getContext(d) || this.isIndent ? q : r },
                    ...
                    i.registerCommands(e,
                        { indentlist: new g(e, "indentlist", !0), outdentlist: new g(e, "outdentlist") });
    ...
    (function() {
        ...
        CKEDITOR.editor.prototype.restoreRealElement =
            function(a) {
                ...
                var b = CKEDITOR.dom.element.createFromHtml(decodeURIComponent(a.data("cke-realelement")),
                    this.document);
    ...
    CKEDITOR.plugins.add("link",
        {
            ...
            init: function(b) {
                ...
                (b.ui.addButton("Link", { label: b.lang.link.toolbar, command: "link", toolbar: "links,10" }),
                    ...
                    b.ui.addButton("Anchor",
                        { label: b.lang.link.anchor.toolbar, command: "anchor", toolbar: "links,30" }));
            ...
            afterInit: function(b) {
                ...
                c &&
                    c.push(function(a, c) {
                        if ("a" == c &&
                        (CKEDITOR.plugins.link.tryRestoreFakeAnchor(b,
                                a) ||
                            a.getAttribute("name") && (!a.getAttribute("href") || !a.getChildCount()))) return"anchor"
                    })
            }
        });
    ...
    (function() {
        function E(c, k, e) {
            function b(b) {
                if ((d = a[b ? "getFirst" : "getLast"]()) &&
                    ...
                    (m = k.root[b ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) &&
            ...
            var a = CKEDITOR.plugins.list.arrayToList(j, e, null, c.config.enterMode, k.root.getAttribute("dir"))
                    .listNode,
                d,
                m;
            b(!0);
        ...
        function A(c, k, e, b) {
            for (var j, g; j = c[b ? "getLast" : "getFirst"](F);)
                (g = j.getDirection(1)) !== k.getDirection(1) && j.setAttribute("dir", g), j.remove(), e
                    ? j[b ? "insertBefore" : "insertAfter"](e)
                    : k.append(j, b)
        }
                ...
                for (var g = 0, h = c.getChildCount(); g < h; g++) {
                    ...
                    if ("li" == f.$.nodeName.toLowerCase()) {
                        ...
                        for (var d = 0, m = f.getChildCount(), i; d < m; d++)
                            i = f.getChild(d), i.type == CKEDITOR.NODE_ELEMENT && r[i.getName()]
                                ? CKEDITOR.plugins.list.listToArray(i, k, e, b + 1, a.grandparent)
                                : a.contents.push(i)
                    }
                }
                return e
            ...
            arrayToList: function(c, k, e, b, j) {
                ...
                for (var g,
                    ...
                    if (o.indent == m) {
                        ...
                        o = c[d - 1].element.getDirection(1), d =
                                CKEDITOR.plugins.list.arrayToList(c, null, d, b, o != n ? n : null),
                            !i.getChildCount() &&
                            ...
                            if (s = o.contents[g], D(s) && 1 < x) w ? t = s.clone(1, 1) : i.append(s.clone(1, 1));
                                ...
                                w
                                    ? (l || (l = h.createElement(p), i.append(l), a && l.setAttribute("dir", n)),
                                        v && l.setAttribute("style", v), z && l.setAttribute("class", z), t &&
                                            (l.append(t), t = null), l.append(s.clone(1, 1)))
                                    : i.append(s.clone(1, 1));
                        ...
                        i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                            ...
                            (CKEDITOR.env.needsBrFiller &&
                                ...
                                n.remove(), n =
                                i.getLast(q), (!n || !(n.type == CKEDITOR.NODE_ELEMENT && n.is(CKEDITOR.dtd.$block))) &&
                ...
                if (k)
                    for (c = f.getFirst(); c;) {
                        if (c.type == CKEDITOR.NODE_ELEMENT &&
                        (CKEDITOR.dom.element.clearMarkers(k, c), c.getName() in
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    if (j.getFirst(q)) {
                        ...
                        k.enterMode == CKEDITOR.ENTER_BR
                            ? j.appendBogus()
                            : b[0].fixBlock(1, k.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), e.selectRanges(b)
                }
                for (var k = e.createBookmarks(!0), j = [], h = {}, b = b.createIterator(), f = 0;
                    ...
                    for (g.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; a = g.getNextParagraph();)
                        if (!a.getCustomData("list_block")) {
                            ...
                            m ||
                            (m = i, m.getCustomData("list_group_object_" + f)
                ...
                for (n = []; 0 < j.length;)
                    if (d = j.shift(), this.state == CKEDITOR.TRISTATE_OFF)
                        if (r[d.root.getName()]) {
                            ...
                            1 == i.length &&
                                i[0].equals(a.root) &&
                                (d = b.createElement("div"), i[0].moveChildren && i[0].moveChildren(d), i[0].append(d),
                                    i[0] = d);
                            ...
                            if (!(1 > f.length)) {
                                ...
                                for (p = g = void 0; f.length;)
                                    g = f.shift(), p =
                                        b.createElement("li"), g.is("pre") ||
                                        H.test(g.getName()) ||
                                        "false" == g.getAttribute("contenteditable")
                                        ? g.appendTo(p)
                                        : (g.copyAttributes(p), d &&
                                            g.getDirection() &&
                                            (p.removeStyle("direction"), p.removeAttribute("dir")), g.moveChildren(p), g
                                            .remove()), p.appendTo(l);
        ...
        CKEDITOR.plugins.add("list",
            {
                ...
                init: function(c) {
                    c.blockless ||
                    (c.addCommand("numberedlist", new x("numberedlist", "ol")), c.addCommand("bulletedlist",
                        new x("bulletedlist", "ul")), c.ui.addButton &&
    ...
    (function() {
        function Q(a, c, d) {
            return m(c) && m(d) && d.equals(c.getNext(function(a) { return!(z(a) || A(a) || p(a)) }))
        }
        ...
        function ha(a) {
            var c = a.doc,
                d = B('<span contenteditable="false" style="' +
                    L +
                    ...
                    lineChildren: [
                        q(B('<span title="' +
                                ...
                                c),
                            {
                                ...
                                looks: [
                                    "top:-8px;" +
                                    CKEDITOR.tools.cssVendorPrefix("border-radius",
                                        "2px",
                                        1),
                                    "top:-17px;" +
                    ...
                    place: function() {
                        ...
                        l.equals(c)
                            ...
                            : (k.left = j.size.left -
                                j.size.margin.left +
                                b.scroll.x -
                                (a.inInlineMode ? b.editable.left + b.editable.border.left : 0), k.width =
                                j.size.outerWidth + j.size.margin.left + j.size.margin.right + b.scroll.x, k.right =
                                "");
                        h && g
                            ? k.top = h.size.margin.bottom === g.size.margin.top
        ...
        function N(a, c, d) {
            ...
            n.ie && a.enterMode == CKEDITOR.ENTER_BR
                ...
                : (f = (f = K(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, f =
                    new M(F[f], a.doc), f.is("br") || a.doc.createText(E).appendTo(f));
        ...
        function Y(a) {
            ...
            return!f && 0 <= c.size.top && 0 < d.y && d.y < c.size.top + e
                ...
                ? (a =
                    a.inInlineMode || c.size.bottom > b.pane.height - e && c.size.bottom < b.pane.height ? y : s, new u(
                    [c, null, Z, H, a]))
                : null
        }
            ...
            if (g) {
                ...
                e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant))
                    ? (C(a), h &&
                        ...
                        c.y < e.size.top + b &&
                        (i = x))
                    : i = s, f = [null, e][h ? "reverse" : "concat"]().concat([
                    h ? Z : D, H, i, e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? h ? y : x : s
                ]);
        ...
        function P(a, c, d, b) {
            for (var e = function() {
                    ...
                    return n.ie
                        ? function(a) { return b[CKEDITOR.tools.cssStyleToDomStyle(a)] }
                        : function(a) { return b.getPropertyValue(a) }
                }(),
        ...
        function la(a, c, d, b) {
            for (var e = b, f = b, i = 0, h = !1, g = !1, j = a.view.pane.height, l = a.mouse;
                l.y + i < j && 0 < l.y - i;
            ) {
                h || (h = c(e, b));
                g || (g = c(f, b));
                ...
                init: function(a) {
                    ...
                    a.on("contentDom",
                        function() {
                            ...
                            d.is(w.$inline) ||
                            (b.inInlineMode && !X(d) && d.setStyles({ position: "relative", top: null, left: null }),
                                ha.call(this, b), I(b),
                                d.attachListener(a, "beforeUndoImage", function() { b.line.detach() }),
                                d.attachListener(a,
                                    "beforeGetData",
                                    function() {
                                        b.line.wrap.getParent() &&
                                        (b.line.detach(), a.once("getData",
                                            function() { b.line.attach() },
                                            null,
                                            null,
                                            1E3))
                                    },
                                    null,
                                    null,
                                    0), d.attachListener(b.inInlineMode ? g : g.getWindow().getFrame(),
                                    "mouseout",
                                    function(c) {
                                        if ("wysiwyg" == a.mode)
                                            if (b.inInlineMode) {
                                    ...
                                    }), d.attachListener(d, "keyup", function() { b.hiddenMode = 0 }), d.attachListener(
                                    d,
                                    "keydown",
                                    function(c) {
                                        if ("wysiwyg" == a.mode)
                                    ...
                                    }), d.attachListener(b.inInlineMode ? d : g,
                                    "mousemove",
                                    function(c) {
                                        f = !0;
                                            ...
                                            i = setTimeout(function() {
                                                    ...
                                                    if (f &&
                                                        ...
                                                        (b.trigger = Y(b) || $(b) || da(b)) &&
                                                            ...
                                                            ? b.line.attach().place()
                                                            : (b.trigger = null, b.line.detach()), f = !1
                                                },
                                                30)
                                        }
                                    }), d.attachListener(j,
        ...
        var ca = function() {
            ...
            da = function() {
                function a(a) {
                    ...
                    if (!(a.mouse.y >
                        e.size.top &&
                        a.mouse.y < f.size.bottom)) return null;
                ...
                function c(a, b) {
                    return!(b && b.type == CKEDITOR.NODE_TEXT ||
                        A(b) ||
                        p(b) ||
                        v(a, b) ||
                ...
                var d = function(c) {
                    ...
                    (a.on && b
                        ...
                        (b = a.menu =
                                ...
                                this),
                            this.onMenu && b.addListener(this.onMenu)), this.setState(CKEDITOR.TRISTATE_ON), a.on =
                            1, setTimeout(function() { b.show(CKEDITOR.document.getById(a.id), 4) }, 0)))
                };
        ...
        var j = "",
            r = function() {
                ...
                b.on("beforeCommandExec",
                    function(a) { "source" == a.data.name && "source" == b.mode && d.markControlRestore(b) });
                b.on("afterCommandExec",
                    function(a) {
                        if (d.isScaytEnabled(b) &&
                            "wysiwyg" ==
                            b.mode &&
                            ("undo" == a.data.name || "redo" == a.data.name))
                            d.getScayt(b).setDisabled(!0), d.refresh_timeout && window.clearTimeout(d.refresh_timeout),
                    ...
                    function(a) {
                        return function() {
                            ...
                            c && d.isScaytReady(this)
                                ? (b = c.reset(this.getSnapshot()), c = c.reset(this._.previousValue), b = b !== c)
                                : b = a.apply(this);
                            return b
                        }
                    });
        ...
        CKEDITOR.plugins.scayt = {
            ...
            loadEngine: function(a) {
                if (CKEDITOR.env.gecko &&
                    ...
                    CKEDITOR.env.opera ||
                    CKEDITOR.env.air) return a.fire("showScaytState");
                        ...
                        a.contextMenu.addListener(function(b, c) {
                            ...
                            if (!i || !i.length) {
                                ...
                                for (var k = 0, r = i.length; k < r; k = k + 1) {
                                    var q = "scayt_suggestion_" + i[k].replace(" ", "_"),
                                        t = function(a, b) { return{ exec: function() { f.replace(a, b) } } }(n, i[k]);
                                    if (k < s) {
                                        p(a,
                                            "button_" + q,
                                            i[k],
                            ...
                            if (o("all", l) || o("add", l)) {
                                p(a,
                                    ...
                                    h.addWord,
                                    "scayt_add_word",
                                    { exec: function() { window.scayt.addWordToUserDictionary(n) } },
                                    "scayt_control",
                                    4);
                    ...
                    c.ui.addRichCombo("Styles",
                        {
                            ...
                            onRender: function() {
                                c.on("selectionChange",
                                    function(b) {
                                        for (var a = this.getValue(), b = b.data.path.elements, c = 0, d = b.length, g;
                                            c < d;
                                            c++) {
                                            g = b[c];
                                            for (var f in e)
        ...
        function o(e, d) {
            for (var b = p(e),
                ...
                1 < a[h].rowSpan && g && a[h] == g[h]
                    ? (i = a[h], i.rowSpan += 1)
                    : (i =
                            (new CKEDITOR.dom.element(a[h])).clone(), i.removeAttribute("rowSpan"), i.appendBogus(),
                        c.append(i), i = i.$);
                h += i.colSpan - 1
            }
        ...
        function k(e, d) {
            ...
            for (h = 0; h < g; h++)
                ...
                (1 < c[h].colSpan &&
                    ...
                    ? (a = c[h], a.colSpan += 1)
                    : (a =
                            (new CKEDITOR.dom.element(c[h])).clone(), a.removeAttribute("colSpan"), a.appendBogus(),
                        a[d ? "insertBefore" : "insertAfter"].call(a, new CKEDITOR.dom.element(c[h])), a = a.$), h += a
                    .rowSpan -
                    1)
        }
        ...
        function s(e,
            ...
            if (d) {
                ...
                c["up" == d ||
                    ...
                    d
                    ? "unshift"
                    : "push"](new CKEDITOR.dom.element(n))
            }
            for (var d = e.getDocument(),
                o = j,
                m = n = 0,
        ...
        f.prototype = {
            ...
            equalsSelection: function(a) {
                ...
                if (c || a) {
                    ...
                    for (var d = 0; d < c.length; d++) {
                        var b = c[d], e = a[d];
                        if (b.startOffset != e.startOffset ||
                            b.endOffset != e.endOffset ||
                            !CKEDITOR.tools.arrayCompare(b.start, e.start) ||
                            !CKEDITOR.tools.arrayCompare(b.end, e.end)) return!1
                    }
                }
                return!0
            }
        ...
        g.prototype = {
            type: function(a, c) {
                ...
                (this.wasCharacter =
                        c)
                    ? (this.modifiersCount =
                        0, this.typesCount++, 25 < this.typesCount
                        ? (this.save(!1, null, !1), this.typesCount = 1)
                        : setTimeout(function() { b.fire("change") }, 0))
                    : (this.typesCount = 0, this.modifiersCount++, 25 < this.modifiersCount
            ...
            update: function(a) {
                if (!this.locked) {
                    ...
                    for (var c = this.index, d = this.snapshots;
                ...
                this.locked
                    ...
                    : (a = new f(this.editor, !0), this.locked = {
                        update: this.currentImage &&
                            this.currentImage.equalsContent(a)
                            ? a
                            : null,
                        level: 1
                    })
